...
ID3D12Resource* CreateTextureResource(ID3D12Device* device, const DirectX::TexMetadata& metaData) {
	...
	heapPropaties.Type = D3D12_HEAP_TYPE_CUSTOM;
	heapPropaties.CPUPageProperty = D3D12_CPU_PAGE_PROPERTY_WRITE_BACK;
	heapPropaties.MemoryPoolPreference = D3D12_MEMORY_POOL_L0;
