...
uint32_t TextureManager::kSRVIndexToo = 1;
...
void TextureManager::LoadTexture(const std::wstring& filePath)
{
	...
	//}
	//
	//assert(textureDatas.max_size() + kSRVIndexToo < DirectXCommon::kMaxSRVCount);
	...
	uint32_t srvIndex = static_cast<uint32_t>(textureDatas.size() - 1) + kSRVIndexToo;
